...
.method private setDefaultDataSubNetworkType(II)V
    ...
    const-string v15, "SubscriptionInfoUpdater"

    const-string v16, "setDefaultDataSubNetworkType called with DEFAULT_SUB_ID"
    ...
    :try_start_0
    sget-object v15, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mContext:Landroid/content/Context;
    ...
    invoke-static/range {v15 .. v16}, Landroid/provider/Settings$Global;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;)I
    :try_end_0
    ...
    invoke-virtual {v15, v0}, Lcom/android/internal/telephony/SubscriptionController;->getUserNwMode(I)I

    move-result v14

    .local v14, "userNwType":I
    const/4 v15, -0x1
    ...
    iget-object v15, v0, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mCommandsInterfaces:[Lcom/android/internal/telephony/CommandsInterface;

    const/16 v16, 0x0

    aget-object v15, v15, v16

    const-string v16, "sim2gsmonly"

    invoke-interface/range {v15 .. v16}, Lcom/android/internal/telephony/CommandsInterface;->needsOldRilFeature(Ljava/lang/String;)Z
    ...
    .local v13, "targetSlotId":I
    :goto_1
    sget v15, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->PROJECT_SIM_NUM:I

    if-ge v13, v15, :cond_3

    sget-object v15, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mPhone:[Lcom/android/internal/telephony/Phone;
    ...
    .end local v8    # "slotId1":I
    .end local v9    # "slotId2":I
    .end local v11    # "subId1":I
    .end local v12    # "subId2":I
    .end local v13    # "targetSlotId":I
    .end local v14    # "userNwType":I
    :catch_0
    move-exception v10

    .local v10, "snfe":Landroid/provider/Settings$SettingNotFoundException;
    const-string v15, "Settings Exception reading value at subid for Settings.Global.PREFERRED_NETWORK_MODE"

    move-object/from16 v0, p0

    invoke-direct {v0, v15}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->logd(Ljava/lang/String;)V
    ...
    invoke-static {v15, v0, v1}, Landroid/telephony/TelephonyManager;->getIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    :try_end_1
    ...
    .local v7, "retrySnfe":Landroid/provider/Settings$SettingNotFoundException;
    const-string v15, "SubscriptionInfoUpdater"

    const-string v16, "Settings Exception Reading Value At Index for Settings.Global.PREFERRED_NETWORK_MODE"

    invoke-static/range {v15 .. v16}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    goto :goto_0

    .end local v7    # "retrySnfe":Landroid/provider/Settings$SettingNotFoundException;
    ...
    .restart local v8    # "slotId1":I
    .restart local v9    # "slotId2":I
    .restart local v11    # "subId1":I
    .restart local v12    # "subId2":I
    .restart local v13    # "targetSlotId":I
    .restart local v14    # "userNwType":I
    :cond_2
    move v12, v3
    ...
    invoke-direct {v0, v8, v11, v4}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->setPreferredNwModeForSlot(III)V

    move-object/from16 v0, p0

    invoke-direct {v0, v9, v12, v5}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->setPreferredNwModeForSlot(III)V
    ...
    invoke-interface/range {v15 .. v16}, Lcom/android/internal/telephony/Phone;->getNetworkSelectionMode(Landroid/os/Message;)V
    ...
    invoke-direct {v0, v1, v2, v4}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->setPreferredNwModeForSlot(III)V
