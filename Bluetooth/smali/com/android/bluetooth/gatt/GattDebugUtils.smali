...
.method static handleDebugAction(Lcom/android/bluetooth/gatt/GattService;Landroid/content/Intent;)Z
    ...
    const-string/jumbo v3, "handleDebugAction() action="
    ...
    .line 81
    const-string/jumbo v1, "android.bluetooth.action.GATT_TEST_USAGE"
    ...
    .line 84
    :cond_0
    const-string/jumbo v1, "android.bluetooth.action.GATT_TEST_ENABLE"
    ...
    :cond_2
    const-string/jumbo v1, "android.bluetooth.action.GATT_TEST_CONNECT"
    ...
    .line 91
    .local v5, "type":I
    const-string/jumbo v1, "addr_type"
    ...
    :cond_3
    const-string/jumbo v1, "android.bluetooth.action.GATT_TEST_DISCONNECT"
    ...
    .line 97
    :cond_4
    const-string/jumbo v1, "android.bluetooth.action.GATT_TEST_DISCOVER"
    ...
    :cond_5
    const-string/jumbo v1, "android.bluetooth.action.GATT_PAIRING_CONFIG"
    ...
    .line 105
    const-string/jumbo v1, "auth_req"
    ...
    .line 107
    .local v19, "io_cap":I
    const-string/jumbo v1, "init_key"
    ...
    const-string/jumbo v1, "resp_key"
